...
public class SLDParser {
    ...
    public SLDParser(StyleFactory factory, FilterFactory filterFactory) {
        ...
        this.factory = new StyleFactoryImpl();
    ...
    public void readSLDVersion()
    {
    	if(this.dom!=null)
    	{
    		NodeList sldd = findElements(this.dom,"StyledLayerDescriptor");
    		if(sldd.getLength()!=0)
    		{
    			NamedNodeMap slddAttrs = sldd.item(0).getAttributes();
    			Node version = slddAttrs.getNamedItem("version");
    ...
    public String getStyleParameterTagByVersion()
    {
    ...
    protected Stroke parseStroke(Node root) {
        ...
        list = findElements(((Element) root), getStyleParameterTagByVersion());
        length = list.getLength();
        for (int i = 0; i < length; i++) {
    ...
    protected Font parseFont(Node root) {
        ...
        NodeList list = findElements(((Element) root), getStyleParameterTagByVersion());
        int length = list.getLength();
        for (int i = 0; i < length; i++) {
            Node child = list.item(i);
